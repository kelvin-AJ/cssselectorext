...
function activate(context) {
	...
	const getAttributeStrings = function(document) {
		...
		const ids = idLines.flatMap(line => getAttributefromLine("id",line))
	
		const classes = classLines.flatMap(line => getAttributefromLine("class",line))
	...
	const htmlToCss = function(htmlString) {
